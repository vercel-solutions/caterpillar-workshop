...
export const metadata: Metadata = {
  title: "Caterpillar Equipment Catalog",
  description: "Caterpillar's equipment catalog - Next.js Fundamentals Workshop",
  metadataBase: new URL("https://caterpillar-store-16.vercel.app"),
}
